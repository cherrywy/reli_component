            ...
            <el-card class="box-card">
                <el-form :label-position="labelPosition" label-width="80px">
                    ...
                    <el-form-item label="商品品牌">
                        <el-select v-model="brand_name" @change="brand" filterable allow-create placeholder="请选择品牌">
                    ...
                    <el-form-item label="商品规格">
                        ...
                        <el-button type="text" @click="addSku()">添加规格{{imageUrl}}</el-button>
    
                        <div v-for="spec in specs">
                            <div style="width:100%;padding:10px;background:#eee">
                                <el-select class='sku' v-model="spec.spec_name" filterable allow-create placeholder="请选择规格">
                ...
                <el-button type="primary" @click="submint" style="margin:auto 0; width:100%;">提交</el-button>
            </el-card>
        </el-row>
...
export default {
    ...
    methods: {
        ...
        brand() {
            let newbrandParams = { uid: 1185378158575618, brand_name: this.brand_name };
        ...
        loadAll(type) {
            let bigParams = { uid: 1185378158575618, type: type };
...
.sku_value i.el-input__icon.el-icon-caret-top {
    /*display: none*/
}

.sku_value .el-input__inner {
    /*display: none;*/
}
